...
def get_router_query_engine(file_path: str, llm=None, embed_model=None):
    ...
    summary_query_engine = summary_index.as_query_engine(response_mode="tree_summarize", use_async=True, llm=llm)
...
def get_doc_tools(
    ...
    def vector_query(query: str, page_numbers: Optional[List[str]] = None) -> str:
        ...
        query_engine = vector_index.as_query_engine(
            similarity_top_k=2, filters=MetadataFilters.from_dicts(metadata_dicts, condition=FilterCondition.OR)
        )
